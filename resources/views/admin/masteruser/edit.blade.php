    ...
    <div class="multisteps-form">
        ...
        <div class="row">
            <div class="col-8 col-lg-8 m-auto">
                <form class="multisteps-form__form mb-1" action="{{ url('admin/edituser/' . $masteruser->id) }}" method="POST"
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input id="name" type="text"
                                        ...
                                        name="name" value="{{ $masteruser->name }}" placeholder="eg. Off-White"
                                        autofocus />
                                    @error('name')
                                ...
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <input id="email"
                                        ...
                                        name="email" value="{{ $masteruser->email }}" placeholder="123@sat.co.id" />
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <select class="form-control" name="master_branch_regulars_id">
                                        ...
                                        @foreach ($masterbranchregulars as $namabranch)
                                            <option value="{{ $namabranch->id }}"
                                                {{ $namabranch->id == $masteruser->master_branch_regulars_id ? 'selected' : '' }}>
                                                {{ $namabranch->branch }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    ...
                                    <select class="form-control" name="role_as">
                                        ...
                                        @foreach ([1 => 'Super Admin', 0 => 'User'] as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ $masteruser->role_as == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
