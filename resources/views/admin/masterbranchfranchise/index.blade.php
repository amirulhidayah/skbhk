    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header pb-0">
                <div class="d-lg-flex">
                    <div>
                        <h5 class="mb-0">Data Branch Franchise</h5>
                    ...
                    <div class="ms-auto my-auto mt-lg-0 mt-4">
                        <div class="ms-auto my-auto">
                            <a href={{ url('admin/tambahbranchfranchise') }} class="btn bg-gradient-info btn-sm mb-0">+&nbsp;
                                Tambah</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body px-0 pb-0">
                <div class="table-responsive">
                    <table class="table table-flush" id="products-list">
                        ...
                        <tbody>
                            <?php $nourut = 1; ?>
                            @foreach ($masterbranchfranchise->reverse() as $item)
                                <tr class="thead-light">
                                        ...
                                        <div class="row">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    id="status_{{ $item->id }}" name="status" value="1"
                                                    {{ $item->status ? 'checked' : '' }}>
                                    ...
                                    <td class="text-sm">
                                        <a href={{ '/admin/editbranchfranchise/' . $item->id }} data-bs-toggle="tooltip"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href =
                        `/admin/hapusbranchfranchise/${masterbranchregulerId}`;
                }
            });
        })
    </script>
