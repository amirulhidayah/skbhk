                ...
                <div class="card card-plain card-blog mt-3">
                    ...
                    @if (count($employees) > 0)
                        @foreach ($employees as $employee)
                            <div class="card  p-4 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                ...
                                <form class="multisteps-form__form mb-1"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-4">
                                            <label>NIK</label>
                                            <input type="text" value="{{ rc4_decrypt($employee->nik) }}"
                                                class="form-control" name="nik" readonly />
                                            <input type="text" value="{{ rc4_decrypt($employee->nik) }}"
                                                class="form-control" name="nik" hidden />
                                        </div>
                                        <div class="form-group col-4">
                                            <label>Nama</label>
                                    ...
                                    <div class="row">
                                        <div class=" form-group col-4">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $employee->toko->nama_toko }}" name="nama_toko" readonly />
                                        </div>
                                        <div class="form-group col-4">
