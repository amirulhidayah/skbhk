            ...
            <tbody>
              <?php $nourut=1; ?>
                ...
                <tr class="thead-light">
                  ...
                  <td class="small">{{Carbon\Carbon::parse($item->created_at)->isoFormat('D MMMM Y', 'Do MMMM Y')}}</td> 
                  <td class="small">{{ $item->user ? $item->user->name : 'Tidak ada informasi pembuat' }}</td>
                  <td class="small">{{ $item->editor ? $item->editor->name : 'Tidak ada informasi pengedit' }}</td>
                  <td class="text-sm">
                    <a href="{{('/print/'.$item->id) }}" data-id="{{ $item->id }}" data-bs-toggle="tooltip" class="badge badge-primary reprint-link">Print</a>
                    ...
                    <a href={{('/importskbhk/'.$item->id)}}  data-bs-toggle="modal" data-bs-target="#import" class="badge badge-dark">Unggah</a>
                        ...
                        <div class="modal-dialog mt-lg-10">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ url('/importskbhk/'.$item->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                    ...
                    <a  href="{{('/lihatskbhk/'.$item->id) }}"class="badge badge-secondary" data-id="{{ $item->id }}" data-bs-toggle="tooltip" target="_blank" >Lihat SKBHK</a>
