...
<body>
    ...
    <table align="left">
        ...
        <tr>
            <td><b>  <b>{{ $surat->namattd->jabatan ?? ''}}</b></b></td>
        </tr>
        <tr>
            <tr>
                <td>
